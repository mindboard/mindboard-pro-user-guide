...
* image:icons/mb_import.png[Import ocuments] Import Documents
...
* Move to Archive
* Move to Trashcan
* Export ... Export document into somewhere(e.g. Google Drive).
...
You can customize themes settings.
