...
/////////
[NOTE]
You can find and get __MindBoard 2019__ app from Google Play https://play.google.com/store/apps/details?id=com.mindboardapps.app.mb2019[MindBoard 2019 for S Pen]. 

/////////

=== Export Data from __MindBoard (Pro)__ image:icons/mbp-app-icon.png[MindBoard (Pro) App Icon] to __MindBoard 2019__ image:icons/mb2019-app-icon.png[MindBoard 2019 Icon]
